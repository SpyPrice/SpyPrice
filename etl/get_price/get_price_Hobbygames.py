...
def get_product_info(url, headless=True):
    ...
    try:
        ...
        try:
            ...
            if json_ld_script.count() > 0:
                ...
                if name and price:
                    ...
                    return {"store": "Хоббигеймс", "name": name, "price_str": price_str, "price_float": price_float,
                            "url": url, "extra": {}}
        except Exception:
            pass
        ...
        if price_elem.count() > 0:
            ...
            if price_clean:
                return {"store": "Хоббигеймс", "name": name, "price_str": price_text, "price_float": float(price_clean),
                        "url": url, "extra": {}}
